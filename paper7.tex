...
$R_{\rm far} = O(c^{-2/3})$, giving a relative
...
\[
  ...
  = O(c^{-1}M^{-1}).
\]
For any fixed $M$, all remainder terms
from Steps~2 and~3 are $o(c^{-1/2})$,
i.e.\ $O(c^{-1/3})$ relative to the main term.
...
\begin{itemize}
  ...
  \item[(b)] Oscillation of $\Ai$:
        on every interval of length $\pi$,
        $\Ai$ has a zero, giving the
        lower bound $|c_\kappa(1+|x_0|)^{-1/4}|$.
