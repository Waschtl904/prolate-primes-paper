...
%% ── FIX (D): zero spacing uniform in mu ─────────────────────────
...
\]
%% ── FIX (A): zeta'(u) = p(u) exact identity cited ───────────────
...
%% ── FIX (B): |x'| bound explicit + FIX (1): quantifier order ────
...
\label{lem:tail-ext}
%% ── FIX (C): M fixed explicitly at the critical point ────────────
...
\Delta < C c^{-2/3}.
\]
%% ── FIX (E): upper constraint clarified ─────────────────────────
