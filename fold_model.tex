...
\label{thm:nolimit}
For $\alpha\ge\tfrac{1}{2}$, $c_3>0$, $u\to-\infty$:
\[
...
\medskip
\noindent\textbf{Density argument.}
The function $\theta(u)=\tfrac{2}{3}\lambda(u)
=\tfrac{2}{3}|u|^{3/2}(3c_3)^{-1/2}$
...
it contains intervals of length $>2\pi$,
hence $\theta(u)\bmod 2\pi$ is dense in $[0,2\pi)$;
no number-theoretic assumptions are required.

\medskip
\noindent\textbf{Conclusion.}
By density, there exist sequences $u_n\to-\infty$ realising
each target phase, giving:
$\limsup |u_n|^{1/2}|\Phi_\alpha(u_n)|=2\sqrt{\pi}$
and
$\liminf |u_n|^{1/2}|\Phi_\alpha(u_n)|=0$.
