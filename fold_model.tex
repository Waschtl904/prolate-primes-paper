...
disentangles these effects and yields the correct scaling
$\lambda\sim|u|^{3/2}$.
...
with $\theta(u)\to+\infty$ as $u\to-\infty$.
Since $\theta$ is continuous and its image
$\theta((-\infty,u_0])$ is an unbounded interval,
$\theta(u)\bmod 2\pi$ is dense in $[0,2\pi)$;
