...
%% ══════════════════════════════════════════════════════════════════
%% FIX: Step 4 — corrected J_2 estimate using (VI.2) directly
%% ══════════════════════════════════════════════════════════════════
...
$t \ge t_* + \Delta \ge \Delta = K c^{-1/2}$,
so $t^{-1/2} \le (Kc^{-1/2})^{-1/2} = K^{-1/2} c^{1/4}$.
Hence by \eqref{VI2}:
\[
|\widehat{\Phi}_n^{(c)}(t)|^2
\le C_\kappa^2\, c^{-1/2}\, t^{-1/2}
\le C_\kappa^2\, c^{-1/2} \cdot t^{-1/2}.
\]
Integrating over $[t_*+\Delta,\, 2t_*]$
with the substitution $t = t_* + c^{-1/2}v$,
$dt = c^{-1/2}\,dv$,
and using $t \ge t_* \asymp c^{1/2}$
so $t^{-1/2} \le C c^{-1/4}$:
\begin{align*}
J_2^+
&\le C_\kappa^2\, c^{-1/2}
